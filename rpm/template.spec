...
%global pkg_name gz_ogre_next_vendor
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-gz-ogre-next-vendor
Version:        0.2.1
Release:        1%{?dist}
...
%changelog
* Thu Apr 30 2026 Michael Carroll <mjcarroll@intrinsic.ai> - 0.2.1-1
- Autogenerated by Bloom

* Wed Apr 29 2026 Michael Carroll <mjcarroll@intrinsic.ai> - 0.2.0-3
- Autogenerated by Bloom

* Tue Apr 28 2026 Michael Carroll <mjcarroll@intrinsic.ai> - 0.2.0-2
- Autogenerated by Bloom

* Tue Apr 21 2026 Michael Carroll <mjcarroll@intrinsic.ai> - 0.2.0-1
- Autogenerated by Bloom
